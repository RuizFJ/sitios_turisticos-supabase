<template>
    ...
    <AppHeader />
    <h1 class="container mt-2">Actualizar la informacion de un sitio turistico</h1>
    <section class="container mt-5 shadow-lg p-3 mb-5 bg-body rounded">
      <form @submit.prevent="actualizarSitio">
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          />
          <div id="descripcionHelp" class="form-text">Descripción del Sitio Turistico</div>
        </div>
        ...
        <div class="mb-3">
          ...
          />
          <div id="direccionHelp" class="form-text">Dirección del Sitio Turistico</div>
        </div>
...
const client: any = useSupabaseClient();
  ...
  onMounted(async () => {
  // Esperar a que se carguen las categorías y ciudades
  await categorias.execute();
  await ciudades.execute();

  // Ahora que están listas, carga el sitio
